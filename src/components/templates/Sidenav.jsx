...
const Sidenav = () => {
  return <div className="w-[20%] h-full border-r-2 border-zinc-400 p-10 ">
    <h1 className="text-2xl text-white font-bold">
         <i className="text-[#6556CD] ri-tv-fill mr-2"></i>
         <span className="text-2xl circular-text">NowFlix.</span>
    </h1>
    ...
    <nav className="flex flex-col text-zinc-400 text-xl gap-3">
        ...
        <Link className="hover:bg-[#6556CD]  hover:text-white duration-300 rounded-lg p-5 text-lg">
        <i className="mr-2 ri-information-fill"></i> About NowFlix
        </Link>
        <Link className="hover:bg-[#6556CD]  hover:text-white duration-300 rounded-lg p-5 text-lg ">
